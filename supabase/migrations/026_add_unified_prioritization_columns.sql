...
-- ==============================================================================
-- NOTE: Backfill is optional and disabled by default to avoid polluting historic sessions.
-- Uncomment the block below only if you explicitly want to seed prior sessions.
