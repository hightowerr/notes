...
Verify compliance with AI Note Synthesiser Constitution v1.1.1:
...
- [ ] **Vertical Slice Architecture**: Tasks deliver complete user value (SEE + DO + VERIFY), no backend-only or frontend-only work
